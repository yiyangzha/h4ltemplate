...
\maketitle
\begin{abstract}
This analysis note documents the Phase 4a expected-only measurement of the Higgs-boson signal strength in the four-lepton final state using CMS 2017 Open Data flat ntuples corresponding to a user-provided target luminosity of 10 fb$^{-1}$ at $\sqrt{s}=13$ TeV. The analysis follows the CMS H to ZZ to four-lepton reference methodology where the available ntuple content allows it, using a simultaneous binned template likelihood in final-state categories over $105 < m_{4\ell} < 140$ GeV. The expected Asimov signal-strength result is $\mu=1.0^{+0.6327358408468291}_{-0.51674064615437}$, with symmetric uncertainty 0.5747382435005995. No observed-data signal-strength result is reported in this document; 10\% and full-data values are reserved for later phases.
\end{abstract}
\tableofcontents
\clearpage
\section*{Change Log}
...
\midrule
1 & profiled Poisson saturated-likelihood deviance i & 16.92 & 17 & 0.4595 & no \\
2 & profiled per-channel shape-only Poisson deviance & 12.97 & 15 & 0.6049 & no \\
3 & profiled Pearson chi2 on the final-state simulta & 22.72 & 17 & 0.1584 & no \\
\bottomrule
\end{tabular}
...
The expected $\mu$ result is contextualized against CMS-HIG-16-041 and CMS-HIG-19-001, but those values are not inputs to the fit and the analysis is not tuned to match them. With the CMS-HIG-16-041 symmetric uncertainty approximated as $(0.19+0.17)/2=0.18$, the Phase 4a expected uncertainty ratio is 0.5747382435005995 / 0.18 = 3.193. The expected central value pull relative to CMS-HIG-16-041 is approximately $(1.0-1.05)/\sqrt{0.5747382435005995^2+0.18^2}=-0.083\sigma$, but this pull is only contextual because one value is an expected Asimov result and the other is an observed CMS publication.

The mass-profile closure best grid point is 125 GeV for the nominal injected template. Compared with the CMS-HIG-16-041 observed mass value of 125.26 GeV and PDG Higgs mass 125.20 GeV, the absolute differences are 0.26 GeV and 0.20 GeV respectively. These are not official pulls because the Phase 4a mass scan is a shifted-template detector-level closure exercise rather than a calibrated mass measurement.

\begin{table}[htbp]
\centering
\caption{Comparison matrix. Pulls are given only where meaningful; non-comparable entries are explicitly labeled.}
\begin{small}
...
\midrule
Inclusive $\mu$ & $1.0^{+0.633}_{-0.517}$ & CMS-HIG-16-041: $1.05^{+0.19}_{-0.17}$ & Contextual, pull $-0.083\sigma$ \\
...
Mass & 125 GeV grid closure & CMS-HIG-16-041: $125.26\pm0.21$ GeV & Not official-quality measurement \\
...
\section{Conclusions}
The expected-only Phase 4a signal-strength measurement is complete enough to support downstream 10\% and full-data updates. The expected result is $\mu=1.0^{+0.6327358408468291}_{-0.51674064615437}$ with symmetric uncertainty 0.5747382435005995 in the $105<m_{4\ell}<140$ GeV fit window. The precision is about 3.193 times weaker than the symmetrized CMS-HIG-16-041 signal-strength uncertainty, which is consistent with the smaller 10 fb$^{-1}$ open-data sample, detector-level simplifications, missing official calibrations, no VBF category, and DY+jets fake-proxy treatment.

The analysis satisfies the expected inference gate with documented limitations. The most important caveats are the grouped MC-stat approximation, the low-count final-state bins, the non-rejected -20\% mass-response corruption test after three final-state-aligned attempts, and the fact that the mass-profile result is closure evidence rather than an official mass measurement.
...
\caption{costheta\_1 input-validation distribution in the broad 70  less than or equal to  m4l  less than or equal to  170 GeV window. The D7 shape gate fails with chi2/ndf = 1.6001492260113015 and p = 0.15619451168087164; this comparison is used only to decide classifier-input eligibility, not to normalize fit templates.}
...
\caption{costheta\_2 input-validation distribution in the broad 70  less than or equal to  m4l  less than or equal to  170 GeV window. The D7 shape gate fails with chi2/ndf = 1.288622678888418 and p = 0.26545662085295785; this comparison is used only to decide classifier-input eligibility, not to normalize fit templates.}
...
\caption{costheta\textasciicircum{}* input-validation distribution in the broad 70  less than or equal to  m4l  less than or equal to  170 GeV window. The D7 shape gate fails with chi2/ndf = 1.007137007365913 and p = 0.4115406899048306; this comparison is used only to decide classifier-input eligibility, not to normalize fit templates.}
...
\caption{eta\_\{4ell\} input-validation distribution in the broad 70  less than or equal to  m4l  less than or equal to  170 GeV window. The D7 shape gate fails with chi2/ndf = 0.40390667035482464 and p = 0.846435676737652; this comparison is used only to decide classifier-input eligibility, not to normalize fit templates.}
...
\caption{Leading lepton |eta| input-validation distribution in the broad 70  less than or equal to  m4l  less than or equal to  170 GeV window. The D7 shape gate passes with chi2/ndf = 0.47344618565668173 and p = 0.7552866554534795; this comparison is used only to decide classifier-input eligibility, not to normalize fit templates.}
...
\caption{Leading lepton p\_T [GeV] input-validation distribution in the broad 70  less than or equal to  m4l  less than or equal to  170 GeV window. The D7 shape gate fails with chi2/ndf = 4.056365380026655 and p = 0.0027310794648283346; this comparison is used only to decide classifier-input eligibility, not to normalize fit templates.}
...
\caption{m\_\{Z1\} [GeV] input-validation distribution in the broad 70  less than or equal to  m4l  less than or equal to  170 GeV window. The D7 shape gate fails with chi2/ndf = 122.06372130729305 and p = 6.222370344736675e-155; this comparison is used only to decide classifier-input eligibility, not to normalize fit templates.}
...
\caption{m\_\{Z2\} [GeV] input-validation distribution in the broad 70  less than or equal to  m4l  less than or equal to  170 GeV window. The D7 shape gate fails with chi2/ndf = 32.08289020695661 and p = 7.490602115287423e-39; this comparison is used only to decide classifier-input eligibility, not to normalize fit templates.}
...
\caption{Phi [rad] input-validation distribution in the broad 70  less than or equal to  m4l  less than or equal to  170 GeV window. The D7 shape gate fails with chi2/ndf = 0.780243891250844 and p = 0.5637239206342102; this comparison is used only to decide classifier-input eligibility, not to normalize fit templates.}
...
\caption{Phi\_1 [rad] input-validation distribution in the broad 70  less than or equal to  m4l  less than or equal to  170 GeV window. The D7 shape gate passes with chi2/ndf = 0.15524017964129577 and p = 0.9785264246346326; this comparison is used only to decide classifier-input eligibility, not to normalize fit templates.}
...
\caption{p\_T\textasciicircum{}\{4ell\} [GeV] input-validation distribution in the broad 70  less than or equal to  m4l  less than or equal to  170 GeV window. The D7 shape gate fails with chi2/ndf = 0.33279924052380305 and p = 0.8934040385491403; this comparison is used only to decide classifier-input eligibility, not to normalize fit templates.}
...
\caption{Subleading lepton |eta| input-validation distribution in the broad 70  less than or equal to  m4l  less than or equal to  170 GeV window. The D7 shape gate fails with chi2/ndf = 1.0759966157041323 and p = 0.36642617632066843; this comparison is used only to decide classifier-input eligibility, not to normalize fit templates.}
...
\caption{Subleading lepton p\_T [GeV] input-validation distribution in the broad 70  less than or equal to  m4l  less than or equal to  170 GeV window. The D7 shape gate fails with chi2/ndf = 849.4760725741927 and p = 0.0; this comparison is used only to decide classifier-input eligibility, not to normalize fit templates.}
...
\caption{y\_\{4ell\} input-validation distribution in the broad 70  less than or equal to  m4l  less than or equal to  170 GeV window. The D7 shape gate fails with chi2/ndf = 996.6794657416361 and p = 0.0; this comparison is used only to decide classifier-input eligibility, not to normalize fit templates.}
...
\caption{DY+jets fake proxy and TTBar diagnostic reducible-background checks across the predeclared sideband and signal regions. TTBar diagnostic / DY+jets fake-proxy ratios are \{'high\_sideband\_140\_170': 0.16348247967166454, 'low\_sideband\_70\_105': 0.09536477980847097, 'signal\_window\_105\_140': 0.04440264879971137\}, so TTBar is not promoted to the nominal fake model by the Phase 2 thresholds.}
