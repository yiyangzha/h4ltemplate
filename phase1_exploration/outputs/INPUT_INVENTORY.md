...
Session: `albert_0f97`
Created: 2026-05-29T18:42:39.946374+00:00
...
| DYJetsToLL.root effective cross section | FOUND_USER_PROVIDED | 5396.0 pb; Metadata nEvents sum=82448537.0 | `prompt.md` user-provided sample list and ROOT Metadata tree | prompt read; `pixi run p1-preselection` |
| GGZZ2E2Mu.root effective cross section | FOUND_USER_PROVIDED | 0.003185 pb; Metadata nEvents sum=499000.0 | `prompt.md` user-provided sample list and ROOT Metadata tree | prompt read; `pixi run p1-preselection` |
| GGZZ4E.root effective cross section | FOUND_USER_PROVIDED | 0.001619 pb; Metadata nEvents sum=992608.0 | `prompt.md` user-provided sample list and ROOT Metadata tree | prompt read; `pixi run p1-preselection` |
| GGZZ4Mu.root effective cross section | FOUND_USER_PROVIDED | 0.001575 pb; Metadata nEvents sum=997445.0 | `prompt.md` user-provided sample list and ROOT Metadata tree | prompt read; `pixi run p1-preselection` |
| GluGluToHToZZ.root effective cross section | FOUND_USER_PROVIDED | 0.006024 pb; Metadata nEvents sum=983914.0 | `prompt.md` user-provided sample list and ROOT Metadata tree | prompt read; `pixi run p1-preselection` |
| TTBar.root effective cross section | FOUND_USER_PROVIDED | 52.7 pb; Metadata nEvents sum=14776503.0 | `prompt.md` user-provided sample list and ROOT Metadata tree | prompt read; `pixi run p1-preselection` |
| VBF_HToZZ.root effective cross section | FOUND_USER_PROVIDED | 0.00048794 pb; Metadata nEvents sum=498000.0 | `prompt.md` user-provided sample list and ROOT Metadata tree | prompt read; `pixi run p1-preselection` |
| WMHToZZ.root effective cross section | FOUND_USER_PROVIDED | 6.706e-05 pb; Metadata nEvents sum=193088.0 | `prompt.md` user-provided sample list and ROOT Metadata tree | prompt read; `pixi run p1-preselection` |
| WPHToZZ.root effective cross section | FOUND_USER_PROVIDED | 0.0001072352 pb; Metadata nEvents sum=294744.0 | `prompt.md` user-provided sample list and ROOT Metadata tree | prompt read; `pixi run p1-preselection` |
| ZHToZZ.root effective cross section | FOUND_USER_PROVIDED | 9.8394e-05 pb; Metadata nEvents sum=486281.0 | `prompt.md` user-provided sample list and ROOT Metadata tree | prompt read; `pixi run p1-preselection` |
| ZZTo4L.root effective cross section | FOUND_USER_PROVIDED | 1.325 pb; Metadata nEvents sum=52104000.0 | `prompt.md` user-provided sample list and ROOT Metadata tree | prompt read; `pixi run p1-preselection` |
