...
def main() -> None:
    ...
    for name, item in validation["variables"].items():
        ...
        save_and_register(fig, f"input_validation_{name}", caption, "phase3_selection/outputs/input_validation.json", {"variable": name, "passes_d7_gate": item["passes_d7_gate"]})
        made += 1
