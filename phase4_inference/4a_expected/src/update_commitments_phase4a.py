...
TEXT_REPLACEMENTS = {
    ...
    "is reported. Proof: injected-mass closure table with bias threshold verdict.": "is reported. Proof: `expected_mass_scan.json` records injected masses 115, 125, and 135 GeV, recovered grid masses, bias threshold verdicts, and per-mass scan rows.",
