...
LOG_DIR = PHASE / "logs"
SESSION = "zoran_44a0"
SESSION_LOG = LOG_DIR / "executor_zoran_44a0_2026-05-30.md"
...
RANDOM_SEED = 4269
OBSERVED_DATA_SEED = 9417
OBSERVED_FRACTION = 1.0
FULL_LUMINOSITY_FB = 10.0
OBSERVED_LUMINOSITY_FB = FULL_LUMINOSITY_FB * OBSERVED_FRACTION
...
def setup_logging(name: str = "phase4c") -> logging.Logger:
    logging.basicConfig(
        level=logging.INFO,
        format="%(message)s",
